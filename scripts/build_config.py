...
def main():
    ...
    CHANNELS = os.environ.get("CHANNELS", "amun.events,conpot.events,thug.events,beeswarm.hive,dionaea.capture,"
                                          "dionaea.connections,thug.files,beeswarm.feeder,cuckoo.analysis,"
                                          "kippo.sessions,cowrie.sessions,glastopf.events,glastopf.files,"
